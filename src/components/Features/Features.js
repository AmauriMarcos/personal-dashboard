  ...
  if (isMobile) {
    featuresBackgroundLeftImg = (
      <Image
        ...
        publicId="newMobilefeaturesBackgroundLeft_c4w690.jpg"
      ></Image>
    );
  } else {
    featuresBackgroundLeftImg = (
      <Image
        cloudName="hrfhxbqio"
        className={styles.backgroundLeft}
        publicId="newfeaturesBackgroundLeft_jwelld.jpg"
      ></Image>
    );
  }
  ...
  if (isMobile) {
    featuresBackgroundRightImg = (
      <Image
        ...
        publicId="newMobileBackgroundRight_s0jshv.jpg"
      ></Image>
    );
  } else {
    featuresBackgroundRightImg = (
      <Image
        cloudName="hrfhxbqio"
        className={styles.backgroundRight}
        publicId="newBackgroundRight_ggzxti.jpg"
      ></Image>
    );
  }
      ...
      <Element id="features-section" name="features-section">
        <div className={styles.Features}>
          <div className={styles.left}>
            <div className={styles.boxImage}>{featuresBackgroundLeftImg}</div>

            <div className={styles.content}>
              <h2>The best solution for your personal finances</h2>
              <p>
                Set goals and use charts to visualize the data tha t matters to
                you. Ut enim ad minim veniam, quis nostrud exercitation ullamco
          ...
          <div className={styles.right}>
            ...
            <div className={styles.boxImage}>{featuresBackgroundRightImg}</div>
          </div>
        </div>
      </Element>
    </React.Fragment>
