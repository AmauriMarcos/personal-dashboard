...
const Product = () => {
  ...
  if (isMobile) {
    productImg = (
      <Image
        cloudName="hrfhxbqio"
        publicId="iPhonePicMobile_wk4lps.jpg"
      ></Image>
    );
  } else {
    productImg = (
  ...
  return (
    <React.Fragment>
      <Element id="product-section" name="product-section">
        <div className={styles.Product}>
          <div className={styles.content}>
            <h2>The best way for managing your money</h2>
            <p>
              It is easy to keep track of your receipts and payments, income and
              outcome in one financial dashboard. Set goals and use charts to
              visualize the data tha t matters to you. Ut enim ad minim veniam,
          ...
          <div className={styles.image}>{productImg}</div>
        </div>
      </Element>
    </React.Fragment>
  );
